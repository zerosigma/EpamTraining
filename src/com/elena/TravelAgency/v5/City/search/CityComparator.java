...
import static com.elena.TravelAgency.v5.City.search.CityFieldOrder.CLIMATE_TYPE;
import static com.elena.TravelAgency.v5.City.search.CityFieldOrder.NAME;
import static com.elena.TravelAgency.v5.common.solution.utils.ComparatorUtils.getComparatorForNullableStrings;
...
public final class CityComparator {
    ...
    private static Comparator<City> getComparatorForClimateType() {
        return new Comparator<City>() {
            @Override
            public int compare(City city1, City city2) {
                return getComparatorForNullableStrings().compare(city1.getClimateType().name(),
