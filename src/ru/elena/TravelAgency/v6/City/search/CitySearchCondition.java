...
public class CitySearchCondition extends BaseSearchCondition<Long> {
    ...
    private ru.elena.TravelAgency.v5.City.search.CityFieldOrder cityFieldOrder;
    ...
    public ru.elena.TravelAgency.v5.City.search.CityFieldOrder getCityFieldOrder() {
